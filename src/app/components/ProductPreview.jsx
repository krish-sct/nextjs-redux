...
import LogoImage from "../../../public/assets/image 82.png";
import VerticalLine from "../../../public/assets/Vector 14.png";
          ...
          <div className="frame-1660">
            ...
            <div className="frame-608">
              ...
              <div className="sample-image">
                ...
                <Image src={LogoImage} alt="image" priority="false"></Image>
              </div>
            </div>
        ...
        <div className="group-583">
          <div className="frame-590">
            <div className="vector-14">
              <Image src={VerticalLine} alt="vector" priority="false"></Image>
            </div>
            <div className="frame-626"></div>
            <div className="vector-13">
              <Image src={VerticalLine} alt="vector" priority="false"></Image>
            </div>
            <div className="group-629">
              <div className="frame-1661">
                <div className="group-573">
                  <div className="frame-571">
                    <div className="text-specification">Specifications</div>
                  </div>
                </div>
              </div>
            </div>
